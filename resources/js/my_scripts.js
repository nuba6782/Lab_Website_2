...
var players = [{name:"John Doe", img: "../resources/img/player1.jpg", alt:"Image of Player 1", year:"Sophomore", major:"Art", games_played: 23, pass_yards: 435, rushing_yards: 200, receiving_yards: 88},
	...
	//Football Season Stats Page:
		function loadStatsPage()
		{
			...
			for(var counter = 2; counter < table.rows.length; counter++)
			{
				...
				if(homescore > oppscore)
				{
					...
					wins += 1;
					//put CU in winner's column
				}
				else
				{
					row.cells[4].innerHTML += row.cells[1].innerHTML;
					losses += 1;
					//put opponent in winner's column
				}
			}

			var totWin = document.getElementById("wins");
			totWin.innerHTML += wins;

			var totLoss = document.getElementById("losses");
			totLoss.innerHTML += losses;
